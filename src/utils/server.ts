...
app.post('/v0/fees', (req, res) => {
    ...
    const makerFee = new BigNumber(2).toString();
    const takerFee = ZeroEx.toBaseUnitAmount(new BigNumber(0), 18).toString();
    const collector= '0xe36ea790bc9d7ab70c55260c66d52b1eca985f84';
    res.status(201).send({
