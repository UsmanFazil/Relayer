...
var BaseContract = /** @class */ (function () {
    function BaseContract(abi, address, provider, defaults) {
        var _this = this;
        ...
        _.each(methodAbis, function (methodAbi) {
            ...
            _this._ethersInterfacesByFunctionSignature[functionSignature] = new ethersContracts.Interface([methodAbi]);
        });
    }
