    ...
    function TokenTransferProxyContract(abi, address, provider, defaults) {
        ...
        _this.addAuthorizedAddress = {
            ...
            getABIEncodedTransactionData: function (target) {
                ...
                target = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [target], base_contract_1.BaseContract._bigNumberToString.bind(self))[0];
                var abiEncodedTransactionData = self
                    ._lookupEthersInterface('addAuthorizedAddress')
                    .functions.addAuthorizedAddress(target).data;
                return abiEncodedTransactionData;
            },
        };
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('authorities(uint256)').inputs;
                                ...
                                encodedData = self._lookupEthersInterface('authorities(uint256)').functions.authorities(index_0).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
        ...
        _this.removeAuthorizedAddress = {
            ...
            getABIEncodedTransactionData: function (target) {
                ...
                target = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [target], base_contract_1.BaseContract._bigNumberToString.bind(self))[0];
                var abiEncodedTransactionData = self
                    ._lookupEthersInterface('removeAuthorizedAddress')
                    .functions.removeAuthorizedAddress(target).data;
                return abiEncodedTransactionData;
            },
        };
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('authorized(address)').inputs;
                                index_0 = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [index_0], base_contract_1.BaseContract._bigNumberToString.bind(self))[0];
                                encodedData = self._lookupEthersInterface('authorized(address)').functions.authorized(index_0).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('getAuthorizedAddresses()').inputs;
                                base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [], base_contract_1.BaseContract._bigNumberToString.bind(self));
                                encodedData = self
                                    ._lookupEthersInterface('getAuthorizedAddresses()')
                                    .functions.getAuthorizedAddresses().data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
