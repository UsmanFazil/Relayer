...
var ExchangeContract = /** @class */ (function (_super) {
    ...
    function ExchangeContract(abi, address, provider, defaults) {
        ...
        _this.isRoundingError = {
            callAsync: function (numerator, denominator, target, callData, defaultBlock) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    var self, inputAbi, encodedData, callDataWithDefaults, rawCallResult, outputAbi, outputParamsTypes, resultArray, _a;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('isRoundingError(uint256,uint256,uint256)').inputs;
                                ...
                                encodedData = self
                                    ._lookupEthersInterface('isRoundingError(uint256,uint256,uint256)')
                                    .functions.isRoundingError(numerator, denominator, target).data;
        ...
        _this.filled = {
            callAsync: function (index_0, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, inputAbi, encodedData, callDataWithDefaults, rawCallResult, outputAbi, outputParamsTypes, resultArray;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('filled(bytes32)').inputs;
                                ...
                                encodedData = self._lookupEthersInterface('filled(bytes32)').functions.filled(index_0).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('cancelled(bytes32)').inputs;
                                index_0 = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [index_0], base_contract_1.BaseContract._bigNumberToString.bind(self))[0];
                                encodedData = self._lookupEthersInterface('cancelled(bytes32)').functions.cancelled(index_0).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
        ...
        _this.fillOrdersUpTo = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }), self.fillOrdersUpTo.estimateGasAsync.bind(self, orderAddresses, orderValues, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, v, r, s))];
                            case 1:
                        ...
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [
                                    ...
                                    r,
                                    s,
                                ], base_contract_1.BaseContract._bigNumberToString.bind(this)), orderAddresses = _a[0], orderValues = _a[1], fillTakerTokenAmount = _a[2], shouldThrowOnInsufficientBalanceOrAllowance = _a[3], v = _a[4], r = _a[5], s = _a[6];
                                encodedData = self
                                    ._lookupEthersInterface('fillOrdersUpTo(address[5][],uint256[6][],uint256,bool,uint8[],bytes32[],bytes32[])')
                                    .functions.fillOrdersUpTo(orderAddresses, orderValues, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, v, r, s).data;
            ...
            getABIEncodedTransactionData: function (orderAddresses, orderValues, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, v, r, s) {
                ...
                var abiEncodedTransactionData = self
                    ._lookupEthersInterface('fillOrdersUpTo')
                    .functions.fillOrdersUpTo(orderAddresses, orderValues, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, v, r, s).data;
        ...
        _this.cancelOrder = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }), self.cancelOrder.estimateGasAsync.bind(self, orderAddresses, orderValues, cancelTakerTokenAmount))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('cancelOrder(address[5],uint256[6],uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [orderAddresses, orderValues, cancelTakerTokenAmount], base_contract_1.BaseContract._bigNumberToString.bind(this)), orderAddresses = _a[0], orderValues = _a[1], cancelTakerTokenAmount = _a[2];
                                encodedData = self
                                    ._lookupEthersInterface('cancelOrder(address[5],uint256[6],uint256)')
                                    .functions.cancelOrder(orderAddresses, orderValues, cancelTakerTokenAmount).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
            ...
            getABIEncodedTransactionData: function (orderAddresses, orderValues, cancelTakerTokenAmount) {
                ...
                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [orderAddresses, orderValues, cancelTakerTokenAmount], base_contract_1.BaseContract._bigNumberToString.bind(self)), orderAddresses = _a[0], orderValues = _a[1], cancelTakerTokenAmount = _a[2];
                var abiEncodedTransactionData = self
                    ._lookupEthersInterface('cancelOrder')
                    .functions.cancelOrder(orderAddresses, orderValues, cancelTakerTokenAmount).data;
                return abiEncodedTransactionData;
                var _a;
            },
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('ZRX_TOKEN_CONTRACT()').inputs;
                                base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [], base_contract_1.BaseContract._bigNumberToString.bind(self));
                                encodedData = self._lookupEthersInterface('ZRX_TOKEN_CONTRACT()').functions.ZRX_TOKEN_CONTRACT().data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
        ...
        _this.batchFillOrKillOrders = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }), self.batchFillOrKillOrders.estimateGasAsync.bind(self, orderAddresses, orderValues, fillTakerTokenAmounts, v, r, s))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('batchFillOrKillOrders(address[5][],uint256[6][],uint256[],uint8[],bytes32[],bytes32[])').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [orderAddresses, orderValues, fillTakerTokenAmounts, v, r, s], base_contract_1.BaseContract._bigNumberToString.bind(this)), orderAddresses = _a[0], orderValues = _a[1], fillTakerTokenAmounts = _a[2], v = _a[3], r = _a[4], s = _a[5];
                                encodedData = self
                                    ._lookupEthersInterface('batchFillOrKillOrders(address[5][],uint256[6][],uint256[],uint8[],bytes32[],bytes32[])')
                                    .functions.batchFillOrKillOrders(orderAddresses, orderValues, fillTakerTokenAmounts, v, r, s).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
            ...
            getABIEncodedTransactionData: function (orderAddresses, orderValues, fillTakerTokenAmounts, v, r, s) {
                ...
                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [orderAddresses, orderValues, fillTakerTokenAmounts, v, r, s], base_contract_1.BaseContract._bigNumberToString.bind(self)), orderAddresses = _a[0], orderValues = _a[1], fillTakerTokenAmounts = _a[2], v = _a[3], r = _a[4], s = _a[5];
                var abiEncodedTransactionData = self
                    ._lookupEthersInterface('batchFillOrKillOrders')
                    .functions.batchFillOrKillOrders(orderAddresses, orderValues, fillTakerTokenAmounts, v, r, s).data;
                return abiEncodedTransactionData;
                var _a;
            },
        ...
        _this.fillOrKillOrder = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }), self.fillOrKillOrder.estimateGasAsync.bind(self, orderAddresses, orderValues, fillTakerTokenAmount, v, r, s))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                inputAbi = self._lookupAbi('fillOrKillOrder(address[5],uint256[6],uint256,uint8,bytes32,bytes32)')
                                    .inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [orderAddresses, orderValues, fillTakerTokenAmount, v, r, s], base_contract_1.BaseContract._bigNumberToString.bind(this)), orderAddresses = _a[0], orderValues = _a[1], fillTakerTokenAmount = _a[2], v = _a[3], r = _a[4], s = _a[5];
                                encodedData = self
                                    ._lookupEthersInterface('fillOrKillOrder(address[5],uint256[6],uint256,uint8,bytes32,bytes32)')
                                    .functions.fillOrKillOrder(orderAddresses, orderValues, fillTakerTokenAmount, v, r, s).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
            ...
            getABIEncodedTransactionData: function (orderAddresses, orderValues, fillTakerTokenAmount, v, r, s) {
                ...
                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [orderAddresses, orderValues, fillTakerTokenAmount, v, r, s], base_contract_1.BaseContract._bigNumberToString.bind(self)), orderAddresses = _a[0], orderValues = _a[1], fillTakerTokenAmount = _a[2], v = _a[3], r = _a[4], s = _a[5];
                var abiEncodedTransactionData = self
                    ._lookupEthersInterface('fillOrKillOrder')
                    .functions.fillOrKillOrder(orderAddresses, orderValues, fillTakerTokenAmount, v, r, s).data;
                return abiEncodedTransactionData;
                var _a;
            },
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('getUnavailableTakerTokenAmount(bytes32)').inputs;
                                ...
                                encodedData = self
                                    ._lookupEthersInterface('getUnavailableTakerTokenAmount(bytes32)')
                                    .functions.getUnavailableTakerTokenAmount(orderHash).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('isValidSignature(address,bytes32,uint8,bytes32,bytes32)').inputs;
                                ...
                                encodedData = self
                                    ._lookupEthersInterface('isValidSignature(address,bytes32,uint8,bytes32,bytes32)')
                                    .functions.isValidSignature(signer, hash, v, r, s).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('getPartialAmount(uint256,uint256,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [numerator, denominator, target], base_contract_1.BaseContract._bigNumberToString.bind(self)), numerator = _a[0], denominator = _a[1], target = _a[2];
                                encodedData = self
                                    ._lookupEthersInterface('getPartialAmount(uint256,uint256,uint256)')
                                    .functions.getPartialAmount(numerator, denominator, target).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('TOKEN_TRANSFER_PROXY_CONTRACT()').inputs;
                                base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [], base_contract_1.BaseContract._bigNumberToString.bind(self));
                                encodedData = self
                                    ._lookupEthersInterface('TOKEN_TRANSFER_PROXY_CONTRACT()')
                                    .functions.TOKEN_TRANSFER_PROXY_CONTRACT().data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }), self.batchFillOrders.estimateGasAsync.bind(self, orderAddresses, orderValues, fillTakerTokenAmounts, shouldThrowOnInsufficientBalanceOrAllowance, v, r, s))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
                        ...
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [
                                    ...
                                    r,
                                    s,
                                ], base_contract_1.BaseContract._bigNumberToString.bind(this)), orderAddresses = _a[0], orderValues = _a[1], fillTakerTokenAmounts = _a[2], shouldThrowOnInsufficientBalanceOrAllowance = _a[3], v = _a[4], r = _a[5], s = _a[6];
                                encodedData = self
                                    ._lookupEthersInterface('batchFillOrders(address[5][],uint256[6][],uint256[],bool,uint8[],bytes32[],bytes32[])')
                                    .functions.batchFillOrders(orderAddresses, orderValues, fillTakerTokenAmounts, shouldThrowOnInsufficientBalanceOrAllowance, v, r, s).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
        ...
        _this.batchCancelOrders = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }), self.batchCancelOrders.estimateGasAsync.bind(self, orderAddresses, orderValues, cancelTakerTokenAmounts))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('batchCancelOrders(address[5][],uint256[6][],uint256[])').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [orderAddresses, orderValues, cancelTakerTokenAmounts], base_contract_1.BaseContract._bigNumberToString.bind(this)), orderAddresses = _a[0], orderValues = _a[1], cancelTakerTokenAmounts = _a[2];
                                encodedData = self
                                    ._lookupEthersInterface('batchCancelOrders(address[5][],uint256[6][],uint256[])')
                                    .functions.batchCancelOrders(orderAddresses, orderValues, cancelTakerTokenAmounts).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }))];
            ...
            getABIEncodedTransactionData: function (orderAddresses, orderValues, cancelTakerTokenAmounts) {
                ...
                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [orderAddresses, orderValues, cancelTakerTokenAmounts], base_contract_1.BaseContract._bigNumberToString.bind(self)), orderAddresses = _a[0], orderValues = _a[1], cancelTakerTokenAmounts = _a[2];
                var abiEncodedTransactionData = self
                    ._lookupEthersInterface('batchCancelOrders')
                    .functions.batchCancelOrders(orderAddresses, orderValues, cancelTakerTokenAmounts).data;
                return abiEncodedTransactionData;
                var _a;
            },
        ...
        _this.fillOrder = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync(__assign({}, txData, { data: encodedData }), self.fillOrder.estimateGasAsync.bind(self, orderAddresses, orderValues, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, v, r, s))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
            ...
            getABIEncodedTransactionData: function (orderAddresses, orderValues, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, v, r, s) {
                ...
                var abiEncodedTransactionData = self
                    ._lookupEthersInterface('fillOrder')
                    .functions.fillOrder(orderAddresses, orderValues, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, v, r, s).data;
                return abiEncodedTransactionData;
                var _a;
            },
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('getOrderHash(address[5],uint256[6])').inputs;
                                ...
                                encodedData = self
                                    ._lookupEthersInterface('getOrderHash(address[5],uint256[6])')
                                    .functions.getOrderHash(orderAddresses, orderValues).data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('EXTERNAL_QUERY_GAS_LIMIT()').inputs;
                                base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [], base_contract_1.BaseContract._bigNumberToString.bind(self));
                                encodedData = self
                                    ._lookupEthersInterface('EXTERNAL_QUERY_GAS_LIMIT()')
                                    .functions.EXTERNAL_QUERY_GAS_LIMIT().data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('VERSION()').inputs;
                                base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [], base_contract_1.BaseContract._bigNumberToString.bind(self));
                                encodedData = self._lookupEthersInterface('VERSION()').functions.VERSION().data;
                                return [4 /*yield*/, self._applyDefaultsToTxDataAsync({
                                        data: encodedData,
                                    })];
                            case 1:
